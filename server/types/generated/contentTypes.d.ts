...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Editable content for the site's dedicated About page (eyebrow label, heading, rich-text body, and the two photos shown on the kitchen-rail composition). Distinct from the homepage's shorter About teaser (home.about-section) \u2014 do not reuse for the homepage.";
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recommendedSearchTags: Schema.Attribute.Component<
      'home.recommended-tag',
      true
    > &
...
export interface ApiIngredientCatalogItemIngredientCatalogItem
  ...
  info: {
    description: '';
    displayName: 'IngredientCatalogItem';
    pluralName: 'ingredient-catalog-items';
    singularName: 'ingredient-catalog-item';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    approvalStatus: Schema.Attribute.Enumeration<['approved', 'pending']> &
      Schema.Attribute.Required &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ingredient-catalog-item.ingredient-catalog-item'
    > &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'canonicalName'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiIngredientMatchCandidateIngredientMatchCandidate
  extends Struct.CollectionTypeSchema {
  collectionName: 'ingredient_match_candidates';
  info: {
    description: '';
    displayName: 'IngredientMatchCandidate';
    pluralName: 'ingredient-match-candidates';
    singularName: 'ingredient-match-candidate';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ingredientName: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ingredient-match-candidate.ingredient-match-candidate'
    > &
      Schema.Attribute.Private;
    matchType: Schema.Attribute.Enumeration<['canonical', 'variant', 'none']> &
      Schema.Attribute.Required;
    normalizedText: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pending'>;
    selectedIngredient: Schema.Attribute.Relation<
      'manyToOne',
      'api::ingredient-catalog-item.ingredient-catalog-item'
    >;
    suggestedIngredient: Schema.Attribute.Relation<
      'manyToOne',
      'api::ingredient-catalog-item.ingredient-catalog-item'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiShirChallengeMonthShirChallengeMonth
  extends Struct.CollectionTypeSchema {
  collectionName: 'shir_challenge_months';
  info: {
    description: 'One record per calendar month. Tracks the monthly ingredient challenge status and admin progress.';
    displayName: 'Shir Challenge Month';
    pluralName: 'shir-challenge-months';
    singularName: 'shir-challenge-month';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiShirChallengePageShirChallengePage
  ...
  info: {
    description: 'Static page-level content for the Shir Challenge page (title, hero, subtitle). Monthly challenge data lives in the shir-challenge-month collection.';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    mobileLogo: Schema.Attribute.Media<'images' | 'files'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
